<?php /* Smarty version Smarty3rc4, created on 2014-03-14 18:58:51
         compiled from "/home/mp3/yujiao/guodong/mis/system/../template/mis/templates/listSearch/mvSearchBar.html" */ ?>
<?php /*%%SmartyHeaderCode:4632484065322e0eb1fdf51-76509586%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ced62699279a133f7644b2eb622878bdebfc1d6' => 
    array (
      0 => '/home/mp3/yujiao/guodong/mis/system/../template/mis/templates/listSearch/mvSearchBar.html',
      1 => 1382339745,
    ),
  ...
  'nocache_hash' => '4632484065322e0eb1fdf51-76509586',
  'function' => 
  array (
  ),
...
"},
     ...
     search_provider: <?php if ($_smarty_tpl->getVariable('option')->value['search_provider']['option']){?>[ 
								<?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('option')->value['search_provider']['option']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if (count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['item']->key;
?> 
...
' : 5
	...
	$('#search_provider').selectfield({
			 labelText: '视频来源',
			 store: Toption.search_provider,
			 value: <?php if (strlen($_smarty_tpl->getVariable('data')->value['current_option']['search_provider'])>0){?>'<?php echo $_smarty_tpl->getVariable('data')->value['current_option']['search_provider'];?>
'<?php }else{ ?>''<?php }?> ? 
							  '<?php echo $_smarty_tpl->getVariable('data')->value['current_option']['search_provider'];?>
' : 5
		});	
...
var searchPageSize = (function(){
	...
	<div id="search_content2" class="x-layout-search-item"></div>
    	...
    	<div id="search_prohibit" class="x-layout-search-item"></div>
	
	
		<div id="search_provider" class="x-layout-search-item"></div>
